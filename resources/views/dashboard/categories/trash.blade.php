    ...
    <table class="table table-hover align-middle text-center">
        ...
        @forelse($categories as $category)
            <tr>
                ...
                <td>
                    @if($category->image)
                        <img src="{{ asset($category->image) }}" alt="{{ $category->name }}" width="60" class="img-thumbnail">
                    @else
                ...
                <td>
                    <form method="POST" action="{{ route('categories.restore', $category->id) }}" onsubmit="return confirm('Are you sure you want to restore this category?')">
                        @csrf
                        @method('PUT')
                ...
                <td>
                    <form method="POST" action="{{ route('categories.forceDelete', $category->id) }}" onsubmit="return confirm('Are you sure you want to force delete this category?')">
                        @csrf
                        @method('DELETE')
