    ...
    <table class="table table-hover align-middle text-center">
        ...
        @forelse($products as $product)
            <tr>
                ...
                <td>
                    @if($product->image)
                        <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" width="60" class="img-thumbnail">
                    @else
                ...
                <td>
                    <form method="POST" action="{{route('dashboard.products.destroy',$product->id)}}" onsubmit="return confirm('Are you sure you want to delete this product?')">
                        @csrf
                        @method('DELETE')
